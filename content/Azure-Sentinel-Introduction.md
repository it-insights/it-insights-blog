...
::blogImage{src="https://docs.microsoft.com/en-us/windows/security/threat-protection/microsoft-defender-atp/images/atp-analyze-auto-ir.png" alt="Microsoft Defender ATP automated investigation (Source: Microsoft)"}
::
...
* Data collection through an increasing number of connectors with the most important being **(GA: New connectors and many out of preview)**
...
* Threat Hunting capabilities **(GA: More out of the box queries)**
  * with custom Kusto queries classified by [MITRE ATT&CK framework](https://attack.mitre.org/)
...
The official reference can be found at [http://aka.ms/kdocs](http://aka.ms/kdocs).
...
::blogImage{src="posts/azure-sentinel-introduction/Workbooks01.JPG" alt="Performance workbook dashboard view"}
::

::blogImage{src="posts/azure-sentinel-introduction/Workbooks02.JPG" alt="Performance workbook edit view"}
::
...
::blogVideo{src="posts/azure-sentinel-introduction/Azure_Notebooks.gif" alt="Azure Notebooks import Jupyter examples"}
::
...
::blogImage{src="posts/azure-sentinel-introduction/SentinelWorkspace01.JPG" alt="Sentinel workspaces overview"}
::

::blogImage{src="posts/azure-sentinel-introduction/SentinelWorkspace02.JPG" alt="Sentinel workspace"}
::
